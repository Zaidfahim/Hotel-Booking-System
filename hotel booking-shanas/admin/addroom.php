        ...
        <div class="well">
            ...
            <form action="" method="post" name="room_category">
                ...
                <div class="form-group">
                    ...
                    <select name="room_qnty" class="form-select">
                        <?php for ($i = 1; $i <= 10; $i++): ?>
                ...
                <div class="form-group">
                    ...
                    <select name="no_bed" class="form-select">
                        <?php for ($i = 1; $i <= 2; $i++): ?>
                                    <option value="<?php echo $i; ?>">
                                        <?php echo $i; ?>
                                    </option>
                ...
                <button type="submit" class="btn btn-lg btn-primary" name="submit" value="Add Room">Add</button>
                <br>
                <div id="click_here">
